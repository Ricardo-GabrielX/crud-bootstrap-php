                ...
                <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="<?php echo BASEURL; ?>/produtos/add.php"><i class="fa-solid fa-box" style="color: #ffffff;"></i> Adicionar Produto</a></li>
                            <li><a class="dropdown-item" href="<?php echo BASEURL; ?>/produtos/"><i class="fa-solid fa-boxes-stacked" style="color: #ffffff;"></i> Gerenciar Produtos</a></li>
                        </ul>
                    </li>
